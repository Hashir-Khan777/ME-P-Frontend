...
const MembershipWork = () => {
  ...
  return (
    <>
      ...
      <br />
      <FlexParent>
      <div style={{ margin: "auto", textAlign: "center", fontSize:'36px',fontWeight:'500',width:'100%' }}>
        <h1 style={{ margin: "auto", textAlign: "center", fontWeight:'600' }} className="sm">How it works</h1>
      </div>
        {cardObj.map((e) => {
          return (
            <div key={e.id}>
        ...
        <div className="lorem">
          ...
          <div>
            <p>
              ...
              aliqua. Non blandit massa enim nec. Scelerisque viverra mauris in
              ...
              diam. Risus in hendrerit gravida rutrum quisque non. Sit amet
              nulla facilisi morbi tempus iaculis urna. Lorem sed risus
